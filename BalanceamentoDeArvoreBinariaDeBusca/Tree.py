...
class No:
    ...
    def rebalancear(self):
        ...
        if self.esq!=None: self.esq.fb = self.esq.alturaLimpa(self.esq.esq) - self.esq.alturaLimpa(self.esq.dir)
        if self.dir!=None: self.dir.fb = self.dir.alturaLimpa(self.dir.esq) - self.dir.alturaLimpa(self.dir.dir)
